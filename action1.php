...
$c=$_POST['DOBadults'];
$d=$_POST['DOBchildren'];
echo "<b>Check in: </b>".$a."<br>";
echo "<b>Check out: </b>".$b."<br>";
echo "<b>Adults: </b>".$c."<br>";
echo "<b>Children: </b>".$d."<br>";
?>
<div class="nav"> Select Room </div>
<div class="rooms">
<br>
<a href="room1.php"><img src="img/2.jpg" width="300" height="250" style="border:4px #AD9748 solid;"></a>
<a href="room2.php"><img src="img/3.jpg" width="300" height="250" style="border:4px #AD9748 solid;"></a>
<a href="room3.php"><img src="img/5.jpg" width="300" height="250" style="border:4px #AD9748 solid;"></a>
 <br>
 <br>
<a href="room4.php"><img src="img/6.jpg" width="300" height="250" style="border:4px #AD9748 solid;"></a>
<a href="room5.php"><img src="img/7.jpg" width="300" height="250" style="border:4px #AD9748 solid;"></a>
<a href="room6.php"><img src="img/8.jpg" width="300" height="250" style="border:4px #AD9748 solid;"></a>
</div>
<br>
<br>
<div class="footer">
