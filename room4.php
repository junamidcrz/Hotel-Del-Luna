...
<div class="headerbtn">
	<ul>
		...
		<li style="float: right; margin-right: 35px;"><a href="signup.php">ADMIN LOGIN</a></li>
		<li style="float: right;"><a href="reservation.php">RESERVATION</a></li>
		<a href="#"><i class="fa fa-facebook-official" style="font-size:24px; color:black; float: right; margin-top: 8px;"></i></a> 
		<a href="#"><i class="fa fa-instagram" style="font-size:24px; color:black; float: right; margin-top: 8px;"></i></a>
		<a href="#"><i class="fa fa-twitter" style="font-size:24px; color:black; float: right; margin-top: 8px;"></i></a>
...
<br>
<center><img src="img/6.jpg" width="350" height="250" style="border:4px #AD9748 solid; margin-right:1%;"></center>
<center> <h3> Deluxe Junior Room </h3></center>
<ul>
    ...
    <li style="margin-right:25%; margin-left:22%; font-size:18px;"> Average Size: 50 sq m / 538 sq ft</li>
    <li style="margin-right:25%; margin-left:22%; font-size:18px;"> Views: Davies Street, inner courtyard or Brook's Mews</li>
    <li style="margin-right:25%; margin-left:22%; font-size:18px;"> Connecting Rooms Available on request </li>
</ul>
<p class="price"> Price: 5,000 pesos/night </p>
<br>
<form action="action9.php" method="get">
