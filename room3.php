...
<br>
<center><img src="img/5.jpg" width="350" height="250" style="border:4px #AD9748 solid; margin-right:1%;"></center>
<center> <h3> Classic King Room </h3></center>
<ul>
    ...
    <li style="margin-right:25%; margin-left:22%; font-size:18px;"> Average Size: 63 sq m / 678 sq ft</li>
	...
	<li style="margin-right:25%; margin-left:22%; font-size:18px;"> Separate, beautiful sitting room </li>
</ul>
<p class="price"> Price: 10,000 pesos/night </p>
<br>
<form action="action7.php" method="get">
